    ...
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-white GlobalPadding">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16 xl:gap-24">
        ...
        <div className="w-full lg:w-auto flex items-center justify-start">
          <div className="w-full max-w-[580px] lg:max-w-[580px] xl:max-w-[660px] relative group transition-transform duration-300 hover:scale-[1.01]">
            <img
        ...
        <div className="w-full lg:w-auto max-w-xl xl:max-w-2xl flex flex-col justify-center">
